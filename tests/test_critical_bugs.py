...
from src.main import main, preprocess_history, get_conversation_display_name
...
class TestCriticalBug1_MissingStatisticsKeys:
    ...
    def test_stats_dict_missing_keys(self, mock_create_dir, mock_getenv, mock_load_json, mock_drive_client, mock_slack_client):
        ...
        mock_slack_instance.fetch_channel_history.return_value = [{"ts": "1234567890.123", "user": "U123", "text": "test"}]
...
class TestCriticalBug3_NoneInStringFormatting:
    ...
    def test_format_timestamp_none_in_fstring(self):
        ...
        assert formatted_time_invalid == "invalid", "format_timestamp should return original string for invalid input"
